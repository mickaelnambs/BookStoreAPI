        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ItemOrdered_BookId = table.Column<int>(type: "int", nullable: false),
                    ItemOrdered_BookTitle = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ItemOrdered_CoverImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
